...
const getCourses = (req, res) => {
  Course.find({teacherId: req.user._id})
  .then((courses) => {  //teacherID: '5758dd2a0fe3293550c9a40d' //currently, I think it may be the case that any authorized user could maliciously add courses for any othr user by swapping the other user's object ID into their cookie; this should perhaps be improved
    res
      .status(200)
      .type('json')
      .json(courses);
